	...
	class MenuBarListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if("manual".equals(e.getActionCommand())) {
				...
				manual += "Einzeltest: \n";
				manual += " Klicken Sie auf die SchaltflŠche \"Einzeltest\" im Haupfenster, um einen einzelnen " +
				"Sortieralgorithmus zu testen. \n";
				manual += " Im Fenster fŸr den Einzeltest kšnnen Sie einen der vier Sortieralgorithmen auswŠhlen,\n";
				manual += " Worst- oder Best-Case wŠhlen und per Schieberegler einstellen, fŸr bis zu wieviel " +
				...
				manual += " Im Fenster fŸr den Vergleichstest kšnnen Sie Worst- oder Best-Case wŠhlen, sowie\n";
				manual += " per Schieberegler einstellen, fŸr bis zu wieviel Elemnten getestet werden soll.\n";
				manual += " Nach einem Klick auf \"GO\" startet das Programm mit der Berechnung und zeigt das " +
				"Ergebnis als Diagramm in einem neuen Fenster an. \n\n";
